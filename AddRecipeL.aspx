<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddRecipeL.aspx.cs" Inherits="AddRecipeL" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="addButton" runat="server" Text="Add Lunch" OnClick="addButton_Click" />        
    </div>
    </form>
</body>
</html>
