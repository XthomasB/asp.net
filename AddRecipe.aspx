...
<body>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="NameFieldValidator5" runat="server" ControlToValidate="nameTB" ErrorMessage="Mandatory" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />

        <asp:Button ID="addButton" runat="server" Text="Add Breakfast" OnClick="addButton_Click" />        
    </div>
    </form>
</body>
</html>
