<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddRecipeDS.aspx.cs" Inherits="AddRecipeDS" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="addButton" runat="server" Text="Add Dessert" OnClick="addButton_Click" />        
    </div>
    </form>
</body>
</html>
